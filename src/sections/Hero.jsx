...
const  [bigShoeImg , setBigShoeImg ] = useState(bigShoe1)
  ...
  return (
    ...
    <section
      id="home"
      className="max-container w-full flex xl:flex-row flex-col justify-center   min-h-screen gap-10 max-container ">
      {/* border-2 */}
      ...
      <div className="relative flex    justify-center items-center xl:min-h-screen max-xl:py-40  bg-primary bg-hero bg-cover bg-center  ">
        ...
        <div className="flex z-20 sm:gap-6 gap-4 absolute -bottom-[-5%] sm:left-[10%] max-sm:px-6 ">
          {shoes.map((shoe) =>
          (<div key={shoe} >
