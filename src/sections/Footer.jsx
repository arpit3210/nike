    ...
    <footer className="max-container">
      ...
      <div className="flex justify-between items-start gap-20 flex-warp max-lg:flex-col">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-white text-base leading-7 mt-6 sm:max-w-sm text-left"> Get shoes ready for the new term at
            <span></span> your nearest Nike store. Find Your perfect Size In Store. Get Rewards </p>
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap ">
          {footerLinks.map((section) => (
            <div key={section} >
              ...
              <ul>
                {section.links.map((link) => <li className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray " > <a >{link.name}</a> </li>)}
...
<div className="flex justify-between text-white-400  mt-24 max-sm:flex-col max:items-center ">
  <div className="flex flex-1 justify-center font-montserrat cursor-pointer items-center gap-2">
